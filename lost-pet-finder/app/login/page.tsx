...
export default function LoginPage() {
  ...
  const { login, isLoading: isAuthLoading } = useUser()
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-pet-primary/10 shadow-lg">
            <CardHeader className="space-y-1 bg-gradient-to-r from-pet-soft to-white border-b border-pet-primary/10">
              <CardTitle className="text-2xl text-pet-primary">Welcome back</CardTitle>
            ...
            <CardFooter className="flex flex-col space-y-4 bg-gradient-to-r from-white to-pet-soft border-t border-pet-primary/10 py-6">
              <div className="text-center text-sm">
                Don't have an account?{" "}
                <Link href="/signup" className="font-medium text-pet-primary hover:underline">
                  Sign up
                </Link>
              </div>
